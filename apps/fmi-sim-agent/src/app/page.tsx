...
function YourMainContent({ themeColor }: { themeColor: string }) {
  ...
  const { state, setState } = useCoAgent<AgentState>({
    ...
    initialState: {
      ...
      fmi: { available_models: [], current_simulation: null, simulation_history: [] },
  ...
  return (
    <div
      style={{ backgroundColor: themeColor }}
      className="h-screen flex flex-row gap-4 p-6 transition-colors duration-300"
      //className="h-screen bg-slate-100 flex flex-row gap-5 p-6"
    >
